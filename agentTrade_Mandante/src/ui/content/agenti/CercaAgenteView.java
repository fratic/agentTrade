...
public class CercaAgenteView extends JDialog {
	
	/*attributi di classe*/
	
	private static final long serialVersionUID = 1L;
	
	private static CercaAgenteView instance;	
	...
	public CercaAgenteView() 
	{
		...
		LabelCerca = new JLabel(Costanti.LABEL_CERCA_AGENTE);
		...
		String[] colNames = Costanti.INTESTAZIONE_TABELLA_CERCA_AGENTI;
	...
	public static CercaAgenteView getInstance(){
		if (instance==null)
			instance = new CercaAgenteView();
		return instance;	 
	}
