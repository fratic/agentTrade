...
//		Version.setPreferredSize(new Dimension(600, 100));
		panel.add(Version);
				...
				JPanel panelJRadioButton = new JPanel();
								...
								JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Agente");
								rdbtnNewRadioButton_1.setSelected(true);
								panelJRadioButton.add(rdbtnNewRadioButton_1);
								
								JRadioButton rdbtnNewRadioButton = new JRadioButton("Mandante");
								panelJRadioButton.add(rdbtnNewRadioButton);
