...
public class Albero extends JPanel {

	/*attributi di classe*/
	
	public static DefaultTreeModel model;
	public static JTree albero;
	protected static Albero instance;
	protected ImageIcon imageIcon;
	protected String nome_radice=Costanti.ROOT_PRODOTTI;
	...
	public Albero() {
		...
		radice = new DefaultMutableTreeNode(nome_radice);
		...
		//imageIcon = new ImageIcon(Albero.class.getResource(Costanti.ALBERO_PREVENTIVI_ICON));
	...
	/*metodi di classe*/
		...
		public static Albero getInstance(){
		
			return ((instance == null) ? instance = new Albero() : instance);	
		}
