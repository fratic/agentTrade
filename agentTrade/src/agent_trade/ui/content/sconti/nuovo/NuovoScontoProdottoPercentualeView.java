...
public class NuovoScontoProdottoPercentualeView extends NuovoScontoFactoryView {
	...
	public NuovoScontoProdottoPercentualeView() {
	...
	public static NuovoScontoProdottoPercentualeView getInstance(){
		if(instance == null)
			instance = new NuovoScontoProdottoPercentualeView();
		return (NuovoScontoProdottoPercentualeView) instance;
	}
