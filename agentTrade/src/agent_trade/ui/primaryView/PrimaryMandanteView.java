...
//		
//			PrimaryMandanteView.getInstance().resetPannelloCentralePreventivo();
//		
...
//		tabbedPrincipale.addTab(Costanti.TAB_PREVENTIVO, new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.PREVENTIVO_ICON)), preventivo, Costanti.TIP_GESTISCI_PREVENTIVO);
...
//		nuovo_preventivo.setIcon(new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.NUOVO_PREVENTIVO_ICON)));
...
//		
//		Cliente = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_CLIENTE, new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.CLIENTE_ICON)), Cliente, Costanti.TIP_GESTISCI_CLIENTE);
...
//		bottoneNuovoCliente.setIcon(new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.NUOVO_CLIENTE_ICON)));
...
//		bottoneCercaCliente.setIcon(new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.CERCA_CLIENTE_ICON)));
...
//		
//		Catalogo = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_CATALOGO, new ImageIcon(PrimaryMandanteView.class.getResource(Costanti.PRODOTTI_ICON)), Catalogo, null);
