...
import agent_trade.ui.login.LoginAgenteView;
import agent_trade.ui.login.LoginMandanteView;
...
public class PrimaryViewFactory extends JFrame 
{
	...
	protected static JPanel intestazione;
	protected static JPanel item;
	
	protected static JPanel riep_intestazione;
	protected static JPanel riep_item;
	
	protected static JPanel pannello_centrale_preventivo;
	
	protected static JPanel dettaglioCliente;
	protected static JPanel riep_cliente;
	
	protected static JPanel pannello_centrale_cliente;
		
	protected static RiepilogoAgenteView riep_agente;
	protected static DettaglioAgenteView dettaglio_agente;
	
	protected static JPanel pannello_centrale_agente;

	
	/*attributi privati*/
	
	protected JButton nuovo_preventivo;
	protected JButton bottoneCercaCliente;
	protected JButton bottoneNuovoCliente;
	
	protected JPanel preventivo;
	protected JPanel panello_menu_preventivo;
	protected JPanel panello_sottomenu_preventivo;
	protected JPanel panello_laterale_preventivo;
	
	
	protected JPanel Cliente;
	protected JPanel panello_menu_cliente;
	protected JPanel panello_sottomenu_cliente;
	protected JPanel panello_laterale_cliente;
	
	
	protected JPanel Catalogo;
	protected JPanel panello_menu_catalogo;
	protected JPanel panello_sottomenu_catalogo;
	protected JPanel panello_laterale_catalogo;
	protected JPanel panello_centrale_catalogo;
	protected JPanel pannelloProdotti;
	
	protected JPanel alberoPreventivi;
	
	protected JPanel alberoClienti;
	
	protected JTabbedPane tabbedPrincipale;
		
	protected JButton bottoneCercaAgente;
	protected JButton bottoneNuovoAgente;
	
	
	
	protected JPanel Agente;
	protected JPanel panello_menu_agente;
	protected JPanel panello_sottomenu_agente;
	protected JPanel panello_laterale_agente;
	
	protected JPanel alberoAgenti;
...
//			instance = new PrimaryViewFactory();
	...
	protected void initTabPreventivo() {
	}
	
	protected void initTabCliente() {
	}
	
	protected void initTabCatalogo() {
	}
	
	protected void initTabAgente() {
	}
...
//		tabbedPrincipale.addTab(Costanti.TAB_PREVENTIVO, new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.PREVENTIVO_ICON)), preventivo, Costanti.TIP_GESTISCI_PREVENTIVO);
...
//		nuovo_preventivo.setIcon(new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.NUOVO_PREVENTIVO_ICON)));
...
//		
//		Cliente = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_CLIENTE, new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.CLIENTE_ICON)), Cliente, Costanti.TIP_GESTISCI_CLIENTE);
...
//		bottoneNuovoCliente.setIcon(new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.NUOVO_CLIENTE_ICON)));
...
//		bottoneCercaCliente.setIcon(new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.CERCA_CLIENTE_ICON)));
...
//		
//		Catalogo = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_CATALOGO, new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.PRODOTTI_ICON)), Catalogo, null);
...
//		
//		Agente = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_AGENTE, new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.AGENTE_ICON)), Agente, Costanti.TIP_GESTISCI_AGENTE);
...
//		bottoneNuovoAgente.setIcon(new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.NUOVO_AGENTE_ICON)));
...
//		bottoneCercaAgente.setIcon(new ImageIcon(PrimaryViewFactory.class.getResource(Costanti.CERCA_AGENTE_ICON)));
