...
//		
//		Agente = new JPanel();
//		tabbedPrincipale.addTab(Costanti.TAB_AGENTE, new ImageIcon(PrimaryAgenteView.class.getResource(Costanti.AGENTE_ICON)), Agente, Costanti.TIP_GESTISCI_AGENTE);
...
//		bottoneNuovoAgente.setIcon(new ImageIcon(PrimaryAgenteView.class.getResource(Costanti.NUOVO_AGENTE_ICON)));
...
//		bottoneCercaAgente.setIcon(new ImageIcon(PrimaryAgenteView.class.getResource(Costanti.CERCA_AGENTE_ICON)));
