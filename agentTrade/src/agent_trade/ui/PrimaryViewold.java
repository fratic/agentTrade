...
public class PrimaryViewold extends JFrame 
{
	
	/*attributi di classe*/
	
	private static PrimaryViewold instance;	
	...
	public static PrimaryViewold getInstance(){
		if (instance==null)
			instance = new PrimaryViewold();
		return instance;	 
	}
	...
	public static void initRiepilogo(){
			...
			PrimaryViewold.getInstance().resetPannelloCentralePreventivo();
	...
	private void initTabPreventivo(){
		...
		tabbedPrincipale.addTab(Costanti.TAB_PREVENTIVO, new ImageIcon(PrimaryViewold.class.getResource(Costanti.PREVENTIVO_ICON)), preventivo, Costanti.TIP_GESTISCI_PREVENTIVO);
		...
		nuovo_preventivo.setIcon(new ImageIcon(PrimaryViewold.class.getResource(Costanti.NUOVO_PREVENTIVO_ICON)));
		panello_menu_preventivo.add(nuovo_preventivo);
		
		/*JButton button = new JButton("");
		button.setIcon(new ImageIcon(PrimaryViewold.class.getResource("/agent_trade/ui/img/save-icon.png")));
		button.setBounds(94, 20, 50, 50);
		panello_menu_preventivo.add(button);
		
		JButton button_1 = new JButton("");
		button_1.setIcon(new ImageIcon(PrimaryViewold.class.getResource("/agent_trade/ui/img/delete.png")));
		button_1.setBounds(168, 20, 50, 50);
		panello_menu_preventivo.add(button_1);
		
		JButton button_2 = new JButton("");
		button_2.setIcon(new ImageIcon(PrimaryViewold.class.getResource("/agent_trade/ui/img/Settings-icon.png")));
		button_2.setBounds(246, 20, 50, 50);
		panello_menu_preventivo.add(button_2);
		
		JButton button_3 = new JButton("");
		button_3.setIcon(new ImageIcon(PrimaryViewold.class.getResource("/agent_trade/ui/img/search-icon.png")));
		button_3.setBounds(323, 20, 50, 50);
		panello_menu_preventivo.add(button_3);
		
		JButton button_4 = new JButton("");
		button_4.setIcon(new ImageIcon(PrimaryViewold.class.getResource("/agent_trade/ui/img/carrelloOrdine.png")));
	...
	private void initTabCliente(){
		...
		Cliente = new JPanel();
		tabbedPrincipale.addTab(Costanti.TAB_CLIENTE, new ImageIcon(PrimaryViewold.class.getResource(Costanti.CLIENTE_ICON)), Cliente, Costanti.TIP_GESTISCI_CLIENTE);
		...
		bottoneNuovoCliente.setIcon(new ImageIcon(PrimaryViewold.class.getResource(Costanti.NUOVO_CLIENTE_ICON)));
		...
		bottoneCercaCliente.setIcon(new ImageIcon(PrimaryViewold.class.getResource(Costanti.CERCA_CLIENTE_ICON)));
	...
	private void initTabCatalogo(){
		...
		Catalogo = new JPanel();
		tabbedPrincipale.addTab(Costanti.TAB_CATALOGO, new ImageIcon(PrimaryViewold.class.getResource(Costanti.PRODOTTI_ICON)), Catalogo, null);
	...
	private void initTabAgente(){
		...
		Agente = new JPanel();
		tabbedPrincipale.addTab(Costanti.TAB_AGENTE, new ImageIcon(PrimaryViewold.class.getResource(Costanti.AGENTE_ICON)), Agente, Costanti.TIP_GESTISCI_AGENTE);
		...
		bottoneNuovoAgente.setIcon(new ImageIcon(PrimaryViewold.class.getResource(Costanti.NUOVO_AGENTE_ICON)));
		...
		bottoneCercaAgente.setIcon(new ImageIcon(PrimaryViewold.class.getResource(Costanti.CERCA_AGENTE_ICON)));
