...
public class PrimaryView_senzaAgente extends JFrame 
{
	
	/*attributi di classe*/
	
	private static PrimaryView_senzaAgente instance;	
	...
	private PrimaryView_senzaAgente() {
	...
	public static PrimaryView_senzaAgente getInstance(){
		if (instance==null)
			instance = new PrimaryView_senzaAgente();
		return instance;	 
	}
	...
	public static void initRiepilogo(){
			...
			PrimaryView_senzaAgente.getInstance().resetPannelloCentralePreventivo();
	...
	private void initTabPreventivo(){
		...
		tabbedPrincipale.addTab(Costanti.TAB_PREVENTIVO, new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.PREVENTIVO_ICON)), preventivo, Costanti.TIP_GESTISCI_PREVENTIVO);
		...
		nuovo_preventivo.setIcon(new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.NUOVO_PREVENTIVO_ICON)));
	...
	private void initTabCliente(){
		...
		Cliente = new JPanel();
		tabbedPrincipale.addTab(Costanti.TAB_CLIENTE, new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.CLIENTE_ICON)), Cliente, Costanti.TIP_GESTISCI_CLIENTE);
		...
		bottoneNuovoCliente.setIcon(new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.NUOVO_CLIENTE_ICON)));
		...
		bottoneCercaCliente.setIcon(new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.CERCA_CLIENTE_ICON)));
	...
	private void initTabCatalogo(){
		...
		Catalogo = new JPanel();
		tabbedPrincipale.addTab(Costanti.TAB_CATALOGO, new ImageIcon(PrimaryView_senzaAgente.class.getResource(Costanti.PRODOTTI_ICON)), Catalogo, null);
