...
public class LoginViewOld extends JFrame {

	/*attributi di classe*/
	
	private static LoginViewOld instance;
	...
	public static LoginViewOld getInstance(){
		if(instance == null)
			instance = new LoginViewOld();
