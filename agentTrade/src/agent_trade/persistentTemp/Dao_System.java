...
//				int a = Integer.parseInt (idAgente);
//				if (c.getCognome().equals(cognome)&& c.getAgenteAssociato().getIdAgente().equals(idAgente)){
////				if (c.getCognome().equals(cognome)&& c.getAgenteAssociato().getIdAgente()==a){
//
//					return c;
//				}
//			}
...
////				if(cliente.getCognome().equals(c)&& cliente.getAgenteAssociato().getIdAgente()==Integer.parseInt(idAgente)){
//
...
////				if(cliente.getAgenteAssociato().getIdAgente()==Integer.parseInt(idAgente)){
//
//					elencoClienti.add(cliente);
//				}
//				
