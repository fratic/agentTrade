...
public class Rem_ScontoPercentDetachedCriteria extends AbstractORMDetachedCriteria {
	public final IntegerExpression id;
	public final FloatExpression percent;
	
	public Rem_ScontoPercentDetachedCriteria() {
		super(agent_trade.model.M_ScontoPercent.class, agent_trade.persistent.Rem_ScontoPercentCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		percent = new FloatExpression("percent", this.getDetachedCriteria());
	}
	
	public Rem_ScontoPercentDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, agent_trade.persistent.Rem_ScontoPercentCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		percent = new FloatExpression("percent", this.getDetachedCriteria());
	}
