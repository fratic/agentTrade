...
public class Rem_ScontoQuantitaDetachedCriteria extends AbstractORMDetachedCriteria {
	public final IntegerExpression id;
	public final IntegerExpression quantita;
	public final FloatExpression scontoFisso;
	
	public Rem_ScontoQuantitaDetachedCriteria() {
		super(agent_trade.model.M_ScontoQuantita.class, agent_trade.persistent.Rem_ScontoQuantitaCriteria.class);
	...
	public Rem_ScontoQuantitaDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, agent_trade.persistent.Rem_ScontoQuantitaCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		quantita = new IntegerExpression("quantita", this.getDetachedCriteria());
		scontoFisso = new FloatExpression("scontoFisso", this.getDetachedCriteria());
	}
