...
public class ScontoQuantitaCriteria extends AbstractORMCriteria {
	public final IntegerExpression id;
	public final IntegerExpression quantita;
	public final FloatExpression scontoFisso;
	
	public ScontoQuantitaCriteria(Criteria criteria) {
		super(criteria);
	...
	public ScontoQuantitaCriteria(PersistentSession session) {
		this(session.createCriteria(M_ScontoQuantita.class));
	}
	
	public ScontoQuantitaCriteria() throws PersistentException {
