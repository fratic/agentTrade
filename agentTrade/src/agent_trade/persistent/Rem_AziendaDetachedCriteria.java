...
public class Rem_AziendaDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public Rem_AziendaDetachedCriteria() {
		...
		super(M_Azienda.class, Rem_AziendaCriteria.class);
	...
	public Rem_AziendaDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		...
		super(aDetachedCriteria, Rem_AziendaCriteria.class);
