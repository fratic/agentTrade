...
public class AgentTradeMandantePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "AgentTradeMandante";
	...
	private AgentTradeMandantePersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AgentTradeMandantePersistentManager();
		}
