...
//		ArrayList<AziendaCarniAdapter> imprese_ricettive = new ArrayList<AziendaCarniAdapter>();
//		for (AziendaCarniAdapter impresa_ricettiva : Costanti.SISTEMI_ESTERNI_AZIENDE_VINIRICETTIVE) {
