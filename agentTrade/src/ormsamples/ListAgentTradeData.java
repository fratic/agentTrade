...
public class ListAgentTradeData {
	...
	public void listTestData() throws PersistentException {
		...
		java.util.List lM_Preventivo_ItemList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Preventivo_Item").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_AgenteList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Agente").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_ClienteList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Cliente").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_LatticiniList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Latticini").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_CarniList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Carni").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_ViniList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Vini").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_DolciList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Dolci").setMaxResults(ROW_COUNT).list();
		...
		java.util.List lM_PreventivoList = agent_trade.persistent.AgentTradePersistentManager.instance().getSession().createQuery("From agent_trade.model.M_Preventivo").setMaxResults(ROW_COUNT).list();
