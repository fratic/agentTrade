...
public class CreateAgentTradeData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Preventivo_Item);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Agente);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Cliente);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Latticini);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Carni);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Vini);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Dolci);
			...
			agent_trade.persistent.AgentTradePersistentManager.instance().getSession().save(lagent_trademodelM_Preventivo);
