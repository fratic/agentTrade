...
--
-- Name: plvswsaw; Type: DATABASE; Schema: -; Owner: plvswsaw
--

CREATE DATABASE plvswsaw WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE plvswsaw OWNER TO plvswsaw;
...
--
-- Name: agente; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE agente OWNER TO plvswsaw;

--
-- Name: agente_idagente_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE agente_idagente_seq OWNER TO plvswsaw;

--
-- Name: agente_idagente_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: plvswsaw
--
...
--
-- Name: azienda_idazienda_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE azienda_idazienda_seq OWNER TO plvswsaw;

--
-- Name: azienda; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE azienda OWNER TO plvswsaw;

--
-- Name: cliente_idcliente_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE cliente_idcliente_seq OWNER TO plvswsaw;

--
-- Name: cliente; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE cliente OWNER TO plvswsaw;

--
-- Name: mandante; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE mandante OWNER TO plvswsaw;

--
-- Name: mandante_idmandante_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE mandante_idmandante_seq OWNER TO plvswsaw;

--
-- Name: mandante_idmandante_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: plvswsaw
--
...
--
-- Name: prodotto_idprodotto_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE prodotto_idprodotto_seq OWNER TO plvswsaw;

--
-- Name: prodotto; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE prodotto OWNER TO plvswsaw;

--
-- Name: sconto; Type: TABLE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE sconto OWNER TO plvswsaw;

--
-- Name: sconto_id_seq; Type: SEQUENCE; Schema: public; Owner: plvswsaw
--
...
ALTER TABLE sconto_id_seq OWNER TO plvswsaw;

--
-- Name: sconto_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: plvswsaw
--
...
--
-- Name: idagente; Type: DEFAULT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: idmandante; Type: DEFAULT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: id; Type: DEFAULT; Schema: public; Owner: plvswsaw
--
...
--
-- Data for Name: agente; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
--
-- Name: agente_idagente_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--
...
--
-- Data for Name: azienda; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
1	Beverage	12345678901	12312312312	Roma	60001	via bo	azienda1@asd.it	3201314598	3201314598	http://fratic.altervista.org/beverage.php	vini	1
...
--
-- Name: azienda_idazienda_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--

SELECT pg_catalog.setval('azienda_idazienda_seq', 1, false);


--
-- Data for Name: cliente; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
--
-- Name: cliente_idcliente_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--
...
--
-- Data for Name: mandante; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
--
-- Name: mandante_idmandante_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--
...
--
-- Data for Name: prodotto; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
--
-- Name: prodotto_idprodotto_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--

SELECT pg_catalog.setval('prodotto_idprodotto_seq', 204, true);


--
-- Data for Name: sconto; Type: TABLE DATA; Schema: public; Owner: plvswsaw
--
...
--
-- Name: sconto_id_seq; Type: SEQUENCE SET; Schema: public; Owner: plvswsaw
--

SELECT pg_catalog.setval('sconto_id_seq', 53, true);


--
-- Name: agente_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: azienda_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: cliente_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: mandante_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: prodotto_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: sconto_pkey; Type: CONSTRAINT; Schema: public; Owner: plvswsaw
--
...
--
-- Name: cliente_m_agenteidagente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: plvswsaw
--
